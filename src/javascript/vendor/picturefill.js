...
!function (a) {
  ...
  a.HTMLPictureElement && /ecko/.test(b) && b.match(/rv\:(\d+)/) && RegExp.$1 < 41 && addEventListener('resize', function () {
    let b, c = document.createElement('source'),
      d = function (a) {
        let b, d, e = a.parentNode;
      ...
      e = function () {
        let a, b = document.querySelectorAll('picture > img, img[srcset][sizes]');
...
function (a, b, c) {
  ...
  function l(a, b) {
    let c, d, e, f, g = a.getElementsByTagName('source');
  ...
  function m(a, b) {
    function c(b) {
      let c, d = b.exec(a.substring(m));
      return d ? (c = d[0], m += c.length, c) : void 0;
    }

    function e() {
      let a, c, d, e, f, i, j, k, l, m = !1,
        o = {};
  ...
  function n(a) {
    ...
    let e, f, g, h, i, j, k = /^(?:[+-]?[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?(?:ch|cm|em|ex|in|mm|pc|pt|px|rem|vh|vmin|vmax|vw)$/i,
      l = /^calc\((?:[0-9a-z \.\+\-\*\/\(\)]+)\)$/i;
  ...
  o = a.console && console.warn ? function (a) {
    ...
    if (a) {
      b = s.parseSet(a);
      for (let c = 0, d = b.length; d > c; c++) _(b[c], a.sizes);
    }
    return b;
  }, s.setRes.res = _, s.applySetCandidate = function (a, b) {
    if (a.length) {
      let c, d, e, f, h, k, l, m, n, o = b[s.ns],
        p = s.DPR;
    ...
    let e, f, g, h, i = b && 'PICTURE' === b.nodeName.toUpperCase(),
      j = a[s.ns];
    ...
    let c, d = b.reselect || b.reevaluate;
    a[s.ns] || (a[s.ns] = {}), c = a[s.ns], (d || c.evaled !== r) && ((!c.parsed || b.reevaluate) && s.parseSets(a, a.parentNode, b), c.supported ? c.evaled = r : h(a));
  }, s.setupRun = function () {
    (!R || L || O !== a.devicePixelRatio) && f();
  }, s.supPicture ? (aa = t, s.fillImg = t) : !function () {
    let c, d = a.attachEvent ? /d$|^c/ : /d$|^c|^i/,
      e = function () {
        const a = b.readyState || '';
