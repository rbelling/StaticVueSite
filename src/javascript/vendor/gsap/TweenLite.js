...
(function (t, e) {
  ...
  if (!i.TweenLite) {
    ...
    const R = v('core.Animation', function (t, e) {
      if (this.vars = e = e || {}, this._duration = this._totalDuration = t || 0, this._delay = Number(e.delay) || 0, this._timeScale = 1, this._active = e.immediateRender === !0, this.data = e.data, this._reversed = e.reversed === !0, H) {
        o || a.wake();
        const i = this.vars.useFrames ? K : H;
    ...
    let I = v('TweenLite', function (e, i, s) {
    ...
    n._init = function () {
      ...
      let s, r, n, a, o, l, h, _, u, f = i && this._time && i._startTime === this._startTime && this._timeline === i._timeline;
      ...
      for (let s = I.getTweensOf(t, e), r = s.length; --r > -1;) s[r]._kill(i, t);
    };
    const te = v('plugins.TweenPlugin', function (t, e) {
    ...
    if (n = te.prototype, te.version = '1.18.0', te.API = 2, n._firstPT = null, n._addTween = j, n.setRatio = N, n._kill = function (t) {
      ...
      for (let e = t.length; --e > -1;) t[e].API === te.API && (Q[(new t[e])._propName] = t[e]);
      return !0;
    }, d.plugin = function (t) {
