  ...
  _gsScope._gsDefine('plugins.ThrowPropsPlugin', ['plugins.TweenPlugin', 'TweenLite', 'easing.Ease', 'utils.VelocityTracker'], function (t, e, i, r) {
    let s, n, o, a, l = function () {
      ...
      d = function (t, e, i, r) {
        ...
        let s = 'function' == typeof t.end ? t.end(e) : t.end instanceof Array ? _(e, t.end, i, r) : Number(t.end);
      ...
      g = function (t, e, i) {
        for (const r in e) void 0 === t[r] && r !== i && (t[r] = e[r]);
        return t;
      },
      m = l.calculateChange = function (t, r, s, n) {
        null == n && (n = .05);
        const o = r instanceof i ? r : r ? new i(r) : e.defaultEase;
        return s * n * t / o.getRatio(n);
      },
      v = l.calculateDuration = function (t, r, s, n, o) {
        o = o || .05;
        const a = n instanceof i ? n : n ? new i(n) : e.defaultEase;
    ...
    return x.constructor = l, l.version = '0.9.8', l.API = 2, l._autoCSS = !0, l.defaultResistance = 100, l.defaultUnitFactors = {
      ...
      const i = r.getByTarget(t);
      return i ? i.getVelocity(e) : 0 / 0;
    }, l._cssRegister = function () {
      const t = p.com.greensock.plugins.CSSPlugin;
      if (t) {
        let e = t._internals,
          i = e._parseToProxy,
          o = e._setPluginRatio,
      ...
      let s, n, l, h, u, p, c, _, v, y = i._ease,
      ...
      for (let i = this._props.length; --i > -1;) null != e[this._props[i].p] && this._props.splice(i, 1);
      return t.prototype._kill.call(this, e);
    }, x._roundProps = function (t, e) {
      for (let i = this._props, r = i.length; --r > -1;)(t[i[r]] || t.throwProps) && (i[r].r = e);
    }, x.setRatio = function (t) {
      for (let e, i, r = this._props.length; --r > -1;) e = this._props[r], i = e.s + e.c1 * t + e.c2 * t * t, e.r && (i = Math.round(i)), e.f ? this.target[e.p](i) : this.target[e.p] = i;
    }, t.activate([l]), l;
