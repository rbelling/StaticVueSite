...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  _gsScope._gsDefine('TweenMax', ['core.Animation', 'core.SimpleTimeline', 'TweenLite'], function (t, e, i) {
    ...
    n.version = '1.18.0', _.constructor = n, _.kill()._gc = !1, n.killTweensOf = n.killDelayedCallsTo = i.killTweensOf, n.getTweensOf = i.getTweensOf, n.lagSmoothing = i.lagSmoothing, n.ticker = i.ticker, n.render = i.render, _.invalidate = function () {
      ...
      if (this._initted || n)
        if (e) this._initted = !1, n && this.render(0, !0, !0);
          ...
          for (let o, l = 1 / (1 - r), h = this._firstPT; h;) o = h.s + h.c, h.c *= l, h.s = o - h.c, h = h._next;
        }
      return this;
    }, _.render = function (t, e, i) {
      this._initted || 0 === this._duration && this.vars.repeat && this.invalidate();
      let s, r, n, l, h, _, u, c, f = this._dirty ? this.totalDuration() : this._totalDuration,
        p = this._time,
        m = this._totalTime,
        d = this._cycle,
        g = this._duration,
    ...
    const p = function (t, i, s, r) {
      i = i !== !1, s = s !== !1, r = r !== !1;
      for (let n, a, o = f(r), l = i && s && r, h = o.length; --h > -1;) a = o[h], (l || a instanceof e || (n = a.target === a.vars.onComplete) && s || i && !n) && a.paused(t);
    };
    ...
    return s.version = '1.18.0', d.constructor = s, d.kill()._gc = d._forcingPlayhead = d._hasPause = !1, d.to = function (t, e, s, r) {
      ...
      if (e instanceof t) {
        this._remove(e, !1);
        const i = e._timeline = e.vars.useFrames ? t._rootFramesTimeline : t._rootTimeline;
      ...
      let s, n, a, o, l, u, c = this._dirty ? this.totalDuration() : this._totalDuration,
        f = this._time,
        p = this._startTime,
        m = this._timeScale,
        d = this._paused;
      ...
      if (t === this._gc)
        for (let s = this._first; s;) s._enabled(t, !0), s = s._next;
      ...
      return arguments.length ? (0 !== this.duration() && 0 !== t && this.timeScale(this._duration / t), this) : (this._dirty && this.totalDuration(), this._duration);
            ...
            return 0 !== this.totalDuration() && 0 !== t && this.timeScale(this._totalDuration / t), this;
                ...
                if (!e)
                    for (let i = this._first, s = this._time; i;) i._startTime === s && 'isPause' === i.data && (i._rawPrevTime = 0), i = i._next;
    ...
    return h.constructor = s, h.kill()._gc = !1, s.version = '1.18.0', h.invalidate = function () {
      ...
      if (t)
        if (null == e) this._kill(null, t);
                            ...
                            for (let i = this.getTweensOf(t, !1), s = i.length, r = this._parseTimeOrLabel(e); --s > -1;) i[s]._startTime === r && i[s]._enabled(!1, !1);
      return this;
      ...
      this._gc && this._enabled(!0, !1);
      let s, n, l, h, _, u, c, f = this._dirty ? this.totalDuration() : this._totalDuration,
        p = this._duration,
        m = this._time,
        d = this._totalTime,
        g = this._startTime,
      ...
      null == t && (t = this._time);
      for (let e = this.getLabelsArray(), i = e.length; --i > -1;)
      ...
      return arguments.length ? this.seek(t, !0) : this.getLabelBefore(this._time + 1e-8);
            ...
            function () {
              let t = 180 / Math.PI,
                ...
                h = function (t, r, n, a, o) {
                  let h, _, u, c, f, p, m, d, g, v, y, T, x, w = t.length - 1,
                    b = 0,
                    P = t[0].a;
                ...
                f = function (t, e, i) {
                  for (let s, r, n, a, o, l, h, _, u, c, f, p = 1 / i, m = t.length; --m > -1;)
                ...
                m = _gsScope._gsDefine.plugin({
                  ...
                  set(e) {
                    let i, s, r, n, a, o, l, h, _, u, c = this._segCount,
                      f = this._func,
                      p = this._target,
                    ...
                    if (this._autoRotate) {
                      let d, g, v, y, T, x, w, b = this._autoRotate;
              ...
              let _, u, c, f, p, m, d = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                ...
                ie = function (t, e, i) {
                  let s = parseFloat('width' === e ? t.offsetWidth : t.offsetHeight),
                    r = te[e],
                    n = r.length;
              ...
              let ce = function (t, e, i, s) {
                  if (null == t) return function (t) {
                    return t;
                  };
                  let r, n = e ? (t.match(ue) || [''])[0] : '',
                ...
                ge = a.parseComplex = function (t, e, i, s, r, n, a, o, l, h) {
                  ...
                  let u, c, f, p, m, v, y, T, x, w, b, P, k, S = i.split(', ').join(',').split(' '),
              ...
              h = ye.prototype, h.parseComplex = function (t, e, i, s, r, n) {
                let a, o, l, h, _, u, c = this.keyword;
              ...
              let we, be = 'scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent'.split(','),
                Pe = W('transform'),
                ke = V + 'transform',
                ...
                Ce = function (t, e, i) {
                  let s, r = E.createElementNS('http://www.w3.org/2000/svg', t),
                    n = /([a-z])([A-Z])/g;
                ...
                Me = function () {
                  let t, e, i, s = m || /Android/i.test(j) && !window.chrome;
                ...
                ze = function (t, e, i, s, r) {
                  let n, o, l, h, _, u, c, f, p, m, d, g, v, y, T = t._gsTransform,
                    x = Ee(t, !0);
                ...
                Ie = [1, 0, 0, 1, 0, 0],
                Ee = function (t, e) {
                  let i, s, r, n, a, o = t._gsTransform || new Oe,
                    l = 1e5;
                ...
                Ne = B.getTransform = function (t, i, s, n) {
                  ...
                  let o, l, h, _, u, c, f = s ? t._gsTransform || new Oe : new Oe,
                    p = 0 > f.scaleX,
                    m = 2e-5,
                    d = 1e5,
                ...
                Xe = B.set3DTransformRatio = B.setTransformRatio = function (t) {
                  let e, i, s, r, n, a, o, l, h, _, u, c, p, m, d, g, v, y, T, x, w, b, P, k = this.data,
                    S = this.t.style,
                    R = k.rotation,
                    O = k.rotationX,
                    A = k.rotationY,
              ...
              h = Oe.prototype, h.x = h.y = h.z = h.skewX = h.skewY = h.rotation = h.rotationX = h.rotationY = h.zOrigin = h.xPercent = h.yPercent = h.xOffset = h.yOffset = 0, h.scaleX = h.scaleY = h.scaleZ = 1, Te('transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin', {
                parser(t, e, i, s, n, o, l) {
                  ...
                  let h, _, u, c, f, p, m, d, g, v, y = t._gsTransform,
                    T = t.style,
                    x = 1e-6,
                    w = be.length,
                    b = l,
                ...
                parser(t, e, i, n, a) {
                  e = this.format(e);
                  let o, l, h, _, u, c, f, p, m, d, g, v, y, T, x, w, b = ['borderTopLeftRadius', 'borderTopRightRadius', 'borderBottomRightRadius', 'borderBottomLeftRadius'],
                    P = t.style;
                ...
                defaultValue: '0 0',
                parser(t, e, i, s, n, a) {
                  let o, l, h, _, u, c, f = 'background-position',
                    p = r || Z(t, null),
              ...
              Te('className', {
                parser(t, e, s, n, a, o, l) {
                  let h, _, u, c, f, p = t.getAttribute('class') || '',
                    m = t.style.cssText;
              ...
              h = a.prototype, h._firstPT = h._lastParsedTransform = h._transform = null, h._onInitTween = function (t, e, o) {
                ...
                let h, f, m, d, g, v, y, T, x, b = t.style;
                ...
                let a, o, h, u, c, f, p, m, d, g, v = t.style;
            ...
            function () {
              let t = _gsScope._gsDefine.plugin({
                  propName: 'roundProps',
                  version: '1.5',
                  priority: -1,
                  API: 2,
            ...
            function () {
              ...
              init(t, e) {
                ...
                let i, s, r, n, a, o, l = e.useRadians === !0 ? 2 * Math.PI : 360,
                  h = 1e-6;
              ...
              let e, i, s, r = _gsScope.GreenSockGlobals || _gsScope,
                n = r.com.greensock,
                a = 2 * Math.PI,
                o = Math.PI / 2,
                l = n._class,
                h = function (e, i) {
                  let s = l('easing.' + e, function () {}, !0),
                    r = s.prototype = new t;
      ...
      if (!i.TweenLite) {
        ...
        let v = [0, 0, 1, 1],
          ...
          w = T.register = function (t, e, i, s) {
            for (let r, n, a, o, l = e.split(','), _ = l.length, u = (i || 'easeIn,easeOut,easeInOut').split(','); --_ > -1;)
        ...
        n = b.prototype, n.addEventListener = function (t, e, i, s, r) {
          ...
          let i, s = this._listeners[t];
          if (s)
            for (i = s.length; --i > -1;)
              if (s[i].c === e) return s.splice(i, 1), void 0;
        }, n.dispatchEvent = function (t) {
          let e, i, s, r = this._listeners[t];
          if (r)
        ...
        let D = g('TweenLite', function (e, i, s) {
            if (O.call(this, i, s), this.render = D.prototype.render, null == e) throw 'Cannot tween a null target.';
            this.target = e = 'string' != typeof e ? e : D.selector(e) || e;
            let r, n, a, o = e.jquery || e.length && e !== t && e[0] && (e[0] === t || e[0].nodeType && e[0].style && !e.nodeType),
        ...
        let F = [],
          ...
          E = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
          N = function (t) {
            for (let e, i = this._firstPT, s = 1e-6; i;) e = i.blob ? t ? this.join('') : this.start : i.c * t + i.s, i.r ? e = Math.round(e) : s > e && e > -s && (e = 0), i.f ? i.fp ? i.t[i.p](i.fp, e) : i.t[i.p](e) : i.t[i.p] = e, i = i._next;
          },
          L = function (t, e, i, s) {
            let r, n, a, o, l, h, _, u = [t, e],
              c = 0,
              f = '',
              p = 0;
        ...
        n._init = function () {
          ...
          let s, r, n, a, o, l, h, _, u, c = i && this._time && i._startTime === this._startTime && this._timeline === i._timeline;
        ...
        const te = g('plugins.TweenPlugin', function (t, e) {
        ...
        if (n = te.prototype, te.version = '1.18.0', te.API = 2, n._firstPT = null, n._addTween = X, n.setRatio = N, n._kill = function (t) {
          ...
          for (let i = this._firstPT; i;)(t[this._propName] || null != i.n && t[i.n.split(this._propName + '_').join('')]) && (i.r = e), i = i._next;
        }, D._onPluginEvent = function (t, e) {
          let i, s, r, n, a, o = e._firstPT;
