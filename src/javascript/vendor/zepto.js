let Zepto = function () {
  ...
  function b(t, e) {
      e(t);
      for (let n = 0, r = t.childNodes.length; r > n; n++) b(t.childNodes[n], e);
    }
    let w, E, j, S, T, C, N = [],
      O = N.slice,
      P = N.filter,
  ...
  return X.matches = function (t, e) {
      if (!e || !t || 1 !== t.nodeType) return !1;
        let n = t.webkitMatchesSelector || t.mozMatchesSelector || t.oMatchesSelector || t.matchesSelector;
      if (n) return n.call(t, e);
        let r, i = t.parentNode,
          o = !i;
      ...
      not: function (t) {
          ...
          if (e(t) && t.call !== w) this.each(function (e) {
              t.call(this, e) || n.push(this);
                ...
                let r = 'string' == typeof t ? this.filter(t) : a(t) && e(t.item) ? O.call(t) : j(t);
      ...
      text: function (t) {
          return 0 in arguments ? this.each(function (e) {
                let n = v(this, t, e, this.textContent);
      ...
      data: function (t, e) {
            let n = 'data-' + t.replace(k, '-$1').toLowerCase(),
      ...
      j.fn[t] = function (i) {
        ...
        let r = n % 2;
      j.fn[e] = function () {
            let e, i, o = j.map(arguments, function (n) {
          ...
          return o.length < 1 ? this : this.each(function (t, e) {
              i = r ? e : e.parentNode, e = 0 == n ? e.nextSibling : 1 == n ? e.firstChild : 2 == n ? e : null;
                let s = j.contains(A.documentElement, i);
    ...
    function (t) {
          ...
          i.split(/\s/).forEach(function (e) {
              ...
              i.proxy = function (t) {
                  if (t = c(t), !t.isImmediatePropagationStopped()) {
                      t.data = u;
                        let e = d.apply(n, t._args == f ? [t] : [t].concat(t._args));
      ...
      g.click = g.mousedown = g.mouseup = g.mousemove = 'MouseEvents', t.event = {
          ...
          remove: u,
            ...
            let i = 2 in arguments && p.call(arguments, 2);
          if (d(n)) {
                let o = function () {
      ...
      t.fn.delegate = function (t, e, n) {
          ...
          return e && !m(e) ? (t.each(e, function (t, e) {
              ...
              o && (a = function (t) {
                  return u(h, t.type, i), i.apply(this, arguments);
                    ...
                    let r, o = t(e.target).closest(n, h).get(0);
          ...
          m(t) || (e = t, t = e.type);
            let n = document.createEvent(g[t] || 'Events'),
              r = !0;
          if (e)
              for (let i in e) 'bubbles' == i ? r = !!e[i] : n[i] = e[i];
