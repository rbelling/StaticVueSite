...
!function (e, n, t) {
  ...
  const S = function () {
    const n = e.matchMedia || e.msMatchMedia;
    return n ? function (e) {
      const t = n(e);
  ...
  C.mq = S;
  const b = C.testStyles = l;
  Modernizr.addTest('touchevents', function () {
    let t;
    if ('ontouchstart' in e || e.DocumentTouch && n instanceof DocumentTouch) t = !0;
    else {
      const o = ['@media (', _.join('touch-enabled),('), 'heartz', ')', '{#modernizr{top:9px;position:absolute}}'].join('');
      b(o, function (e) {
        t = 9 === e.offsetTop;
      });
    }
  ...
  C.atRule = E;
  let z = C._config.usePrefixes ? T.toLowerCase().split(' ') : [];
  C._domPrefixes = z;
  const j = {
    elem: a('modernizr'),
  };
  ...
  const L = C.prefixed = function (e, n, t) {
  ...
  for (let $ = 0; $ < Modernizr._q.length; $++) Modernizr._q[$]();
